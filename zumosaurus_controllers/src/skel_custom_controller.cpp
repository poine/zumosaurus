...
{
SkelCustomController::SkelCustomController() : controller_interface::ControllerInterface() {}

CallbackReturn SkelCustomController::on_init()
{
  try {
...
CallbackReturn SkelCustomController::on_configure(const rclcpp_lifecycle::State & /*previous_state*/)
{
...
controller_interface::InterfaceConfiguration SkelCustomController::command_interface_configuration() const
{
...
controller_interface::InterfaceConfiguration SkelCustomController::state_interface_configuration() const
{
...
CallbackReturn SkelCustomController::on_activate(const rclcpp_lifecycle::State & /*previous_state*/)
{
...
CallbackReturn SkelCustomController::on_deactivate(const rclcpp_lifecycle::State & /*previous_state*/)
{
  return CallbackReturn::SUCCESS;
}

controller_interface::return_type SkelCustomController::update(
...
PLUGINLIB_EXPORT_CLASS(zumosaurus_controllers::SkelCustomController, controller_interface::ControllerInterface)
